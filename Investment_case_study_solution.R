...
# setwd("D:/Lectures/Data Science/Upgrad/Course I - Introduction To Data Management/Sparks Fund Case Study")
...
# Average of venture type funding, angel type funding, seed type funding,
# private_equity type funding
...
# Let's aggreate the raised amount by country and sorting the above frame

highest_funding_countries_sorted <- venture %>% 
...
# some of "category_list" strings are spelled wrong 
# such as "0notechnology" [index- 472]should be "nanotechnology" 
...
# top list: D1, D2 and D3 excluding 'others' for english speaking countries
# are as follows: 
# D1 <- USA
# D2 <- GBR
# D3 <- IND
